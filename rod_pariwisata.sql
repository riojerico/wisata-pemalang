...
insert  into `detail_objek`(`id`,`id_objek`,`detail_objek`) values (1,1,'Tiket masuk Widuri Water Park : <br>\nRp.13.000 (Senin-Jumat) untuk dewasa dan Rp.8.000 untuk anak-anak (Senin-Minggu),<br> Rp.15.000 untuk dewasa (Sabtu-Minggu)'),(3,26,'buka senin-minggu'),(4,26,'harga tiket 5000');
...
insert  into `gallery`(`id`,`id_objek`,`foto`,`title`) values (1,1,'images/gallery/widuriwaterpark1.jpg',NULL),(2,1,'images/gallery/widuriwaterpark2.jpg',NULL),(3,1,'images/gallery/widuriwaterpark3.jpg',NULL),(6,26,'images/gallery/26-Pokemon_GO_Plus_wo_strap.png','fsd');
...
/*Table structure for table `master_jeniswisata` */

DROP TABLE IF EXISTS `master_jeniswisata`;

CREATE TABLE `master_jeniswisata` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `jeniswisata` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `master_jeniswisata` */

insert  into `master_jeniswisata`(`id`,`jeniswisata`) values (1,'Alam'),(2,'Buatan'),(8,'test');
